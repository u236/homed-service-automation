...
public:
    ...
    inline bool match(const QByteArray &value, const QVariant &match) {{ return ConditionObject::match(m_property.isEmpty() ? value : Parser::jsonValue(QJsonDocument::fromJson(value).object(), m_property), match, m_statement); }}
